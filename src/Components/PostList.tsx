...
const PostList = (props: props) => {
  ...
  return (
    <div className='padding-container max-container min-h-[65vh]'>
      ...
      {
      !isFetching? posts?.length!=0?<div className='grid grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-2'>
        {
      ...
      </div>:<div className='flex justify-center items-center w-full h-[70vh]'>
            <h1>No Post Found</h1>
